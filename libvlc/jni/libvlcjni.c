...
#define GET_ID(get, id, clazz, str, args)                                      \
  do {                                                                         \
    ...
    fields.SDK_INT =
        (*env)->GetStaticIntField(env, Version_clazz, SDK_INT_fieldID);
    ...
    GET_CLASS(fields.RuntimeException.clazz, "java/lang/RuntimeException", true);
    GET_CLASS(fields.OutOfMemoryError.clazz, "java/lang/OutOfMemoryError", true);
    GET_CLASS(fields.String.clazz, "java/lang/String", true);
    GET_CLASS(fields.FileDescriptor.clazz, "java/io/FileDescriptor", true);
    GET_ID(GetFieldID, fields.FileDescriptor.descriptorID,
           fields.FileDescriptor.clazz, "descriptor", "I");
    GET_CLASS(fields.VLCObject.clazz, "org/videolan/libvlc/VLCObject", true);
    GET_CLASS(fields.Media.clazz, "org/videolan/libvlc/Media", true);
    GET_CLASS(fields.Media.Track.clazz, "org/videolan/libvlc/Media$Track", true);
    GET_CLASS(fields.Media.Slave.clazz, "org/videolan/libvlc/Media$Slave", true);
    GET_CLASS(fields.MediaPlayer.clazz, "org/videolan/libvlc/MediaPlayer", true);
    ...
    GET_CLASS(fields.MediaDiscoverer.clazz, "org/videolan/libvlc/MediaDiscoverer",
              true);
    ...
    GET_CLASS(fields.Dialog.clazz, "org/videolan/libvlc/Dialog", true);
    GET_CLASS(fields.GLRenderer.clazz, "org/videolan/libvlc/GLRenderer", true);

    GET_ID(GetFieldID, fields.VLCObject.mInstanceID, fields.VLCObject.clazz,
           "mInstance", "J");

    GET_ID(GetFieldID, fields.MediaPlayer.Equalizer.mInstanceID,
           fields.MediaPlayer.Equalizer.clazz, "mInstance", "J");

    GET_ID(GetFieldID, fields.GLRenderer.mInstanceID, fields.GLRenderer.clazz,
           "mInstance", "J");

    GET_ID(GetMethodID, fields.VLCObject.dispatchEventFromNativeID,
           fields.VLCObject.clazz, "dispatchEventFromNative", "(IJJF)V");

    if (fields.SDK_INT <= 13) {
        LOGE("fields.SDK_INT is less than 13 (honeycomb_mr2): using compat "
             "WeakReference");
        GET_ID(GetMethodID, fields.VLCObject.getWeakReferenceID,
               fields.VLCObject.clazz, "getWeakReference", "()Ljava/lang/Object;");
        GET_ID(GetStaticMethodID, fields.VLCObject.dispatchEventFromWeakNativeID,
               fields.VLCObject.clazz, "dispatchEventFromWeakNative",
               "(Ljava/lang/Object;IJJF)V");
    } else {
        fields.VLCObject.getWeakReferenceID = NULL;
        fields.VLCObject.dispatchEventFromWeakNativeID = NULL;
    }

    GET_ID(GetStaticMethodID, fields.Media.createAudioTrackFromNativeID,
           fields.Media.clazz, "createAudioTrackFromNative",
           "(Ljava/lang/String;Ljava/lang/String;IIIILjava/lang/String;Ljava/"
           "lang/String;II)"
           "Lorg/videolan/libvlc/Media$Track;");

    GET_ID(GetStaticMethodID, fields.Media.createVideoTrackFromNativeID,
           fields.Media.clazz, "createVideoTrackFromNative",
           "(Ljava/lang/String;Ljava/lang/String;IIIILjava/lang/String;Ljava/"
           "lang/String;IIIIIIII)"
           "Lorg/videolan/libvlc/Media$Track;");

    GET_ID(GetStaticMethodID, fields.Media.createSubtitleTrackFromNativeID,
           fields.Media.clazz, "createSubtitleTrackFromNative",
           "(Ljava/lang/String;Ljava/lang/String;IIIILjava/lang/String;Ljava/"
           "lang/String;Ljava/lang/String;)"
           "Lorg/videolan/libvlc/Media$Track;");

    GET_ID(GetStaticMethodID, fields.Media.createUnknownTrackFromNativeID,
           fields.Media.clazz, "createUnknownTrackFromNative",
           "(Ljava/lang/String;Ljava/lang/String;IIIILjava/lang/String;Ljava/"
           "lang/String;)"
           "Lorg/videolan/libvlc/Media$Track;");

    GET_ID(GetStaticMethodID, fields.Media.createSlaveFromNativeID,
           fields.Media.clazz, "createSlaveFromNative",
           "(IILjava/lang/String;)"
           "Lorg/videolan/libvlc/Media$Slave;");

    GET_ID(GetStaticMethodID, fields.Media.createStatsFromNativeID,
           fields.Media.clazz, "createStatsFromNative",
           "(IFIFIIIIIIIIIIF)"
           "Lorg/videolan/libvlc/Media$Stats;");

    GET_ID(GetStaticMethodID, fields.MediaPlayer.createTitleFromNativeID,
           fields.MediaPlayer.clazz, "createTitleFromNative",
           "(JLjava/lang/String;I)Lorg/videolan/libvlc/MediaPlayer$Title;");

    GET_ID(GetStaticMethodID, fields.MediaPlayer.createChapterFromNativeID,
           fields.MediaPlayer.clazz, "createChapterFromNative",
           "(JJLjava/lang/String;)Lorg/videolan/libvlc/MediaPlayer$Chapter;");

    GET_ID(GetStaticMethodID,
           fields.MediaPlayer.createTrackDescriptionFromNativeID,
           fields.MediaPlayer.clazz, "createTrackDescriptionFromNative",
           "(ILjava/lang/String;)Lorg/videolan/libvlc/"
           "MediaPlayer$TrackDescription;");

    GET_ID(GetStaticMethodID,
           fields.MediaDiscoverer.createDescriptionFromNativeID,
           fields.MediaDiscoverer.clazz, "createDescriptionFromNative",
           "(Ljava/lang/String;Ljava/lang/String;I)"
           "Lorg/videolan/libvlc/MediaDiscoverer$Description;");

    GET_ID(GetStaticMethodID,
           fields.RendererDiscoverer.createDescriptionFromNativeID,
           fields.RendererDiscoverer.clazz, "createDescriptionFromNative",
           "(Ljava/lang/String;Ljava/lang/String;)"
           "Lorg/videolan/libvlc/RendererDiscoverer$Description;");

    GET_ID(GetStaticMethodID, fields.RendererDiscoverer.createItemFromNativeID,
           fields.RendererDiscoverer.clazz, "createItemFromNative",
           "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJ)"
           "Lorg/videolan/libvlc/RendererItem;");

    GET_ID(GetStaticMethodID, fields.Dialog.displayErrorFromNativeID,
           fields.Dialog.clazz, "displayErrorFromNative",
           "(Ljava/lang/String;Ljava/lang/String;)V");

    GET_ID(GetStaticMethodID, fields.Dialog.displayLoginFromNativeID,
           fields.Dialog.clazz, "displayLoginFromNative",
           "(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)"
           "Lorg/videolan/libvlc/Dialog;");

    GET_ID(GetStaticMethodID, fields.Dialog.displayQuestionFromNativeID,
           fields.Dialog.clazz, "displayQuestionFromNative",
           "(JLjava/lang/String;Ljava/lang/String;ILjava/lang/String;"
           "Ljava/lang/String;Ljava/lang/String;)"
           "Lorg/videolan/libvlc/Dialog;");

    GET_ID(GetStaticMethodID, fields.Dialog.displayProgressFromNativeID,
           fields.Dialog.clazz, "displayProgressFromNative",
           "(JLjava/lang/String;Ljava/lang/String;ZFLjava/lang/String;)"
           "Lorg/videolan/libvlc/Dialog;");

    GET_ID(GetStaticMethodID, fields.Dialog.cancelFromNativeID,
           fields.Dialog.clazz, "cancelFromNative",
           "(Lorg/videolan/libvlc/Dialog;)V");

    GET_ID(GetStaticMethodID, fields.Dialog.updateProgressFromNativeID,
           fields.Dialog.clazz, "updateProgressFromNative",
