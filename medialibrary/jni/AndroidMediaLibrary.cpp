...
void AndroidMediaLibrary::reload() {
    p_ml->reload();
}
...
void AndroidMediaLibrary::forceParserRetry() {
    p_ml->forceParserRetry();
}

void AndroidMediaLibrary::forceRescan() {
    p_ml->forceRescan();
}
...
bool AndroidMediaLibrary::clearHistory() {
...
void AndroidMediaLibrary::detachCurrentThread() {
    myVm->DetachCurrentThread();
}
